          ...
          body: ListView(
            children: [
              ...
              SwitchListTile(
                ...
                subtitle: Text('Applique le thème sombre à l\'application', style: TextStyle(color: theme.colorScheme.onSurface.withValues(alpha: 0.6))),
              ...
              SwitchListTile(
                ...
                subtitle: Text('Recevoir des alertes pour les nouveaux messages', style: TextStyle(color: theme.colorScheme.onSurface.withValues(alpha: 0.6))),
